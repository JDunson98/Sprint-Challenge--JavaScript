...
a method is called by a name that is tied to an object

3. What is closure?

it lets you use an outer scopes function from the inner scope
...
it is used to access the parent class for the constructor
