...
*/
const displayNames = [];
displayNames.forEach(arrItem => {
  displayNames.push(arrItem.animal_name + ',' + arrItem.scientific_name);
})
...
lowerCaseAnimalNames.map((zooAnimal) => zooAnimal.animal_name.toLowerCase())
...
const populationTotal = 0;
  populationTotal = zooAnimals.reduce((acc, zooAnimal) => acc + zooAnimal.population)
